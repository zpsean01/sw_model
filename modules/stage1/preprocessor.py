...
emitting ``#line`` directives (linemarkers) so that AST analysis can map
positions back to original source lines.
"""
...
class Stage1Preprocessor(BaseStage):
    ...
    def run(self, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        output_dir = self.setup_output_dir(params["output_dir"]).resolve()
